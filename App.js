...
var Overlay, Sidebar, i, len, openLink, sectId, section, sections, subBar, subItems, title, w3_close, w3_open;
...
sections = document.getElementsByClassName('sect');
...
if (sections) {
  ...
  for (i = 0, len = sections.length; i < len; i++) {
    section = sections[i];
    section.id = ++sectId;
    title = document.querySelector(`${section.id} h2`).content;
    console.log(title);
